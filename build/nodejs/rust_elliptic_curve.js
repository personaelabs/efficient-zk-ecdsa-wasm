...
module.exports.compute_powers = function(point_row) {
    try {
        ...
        const ptr0 = passStringToWasm0(point_row, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
module.exports.verify_powers = function(point, powers) {
    ...
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(powers, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
const path = require('path').join(__dirname, 'rust_elliptic_curve_bg.wasm');
